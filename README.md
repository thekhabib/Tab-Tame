...
1. Download the latest release zip: [tabtame-v1.0.5.zip](https://github.com/thekhabib/Tab-Tame/releases/download/v1.0.5/tabtame-v1.0.5.zip) (or browse [all releases](https://github.com/thekhabib/Tab-Tame/releases)) and unzip it.
